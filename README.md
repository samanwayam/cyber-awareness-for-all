...
[![Built with HTML](https://img.shields.io/badge/Built%20with-HTML-orange.svg)](https://github.com/samanwayam/cyber-awareness-for-all)
[![Contributions Welcome](https://img.shields.io/badge/Contributions-Welcome-brightgreen.svg)](CONTRIBUTING.md)
[![Kids Safe](https://img.shields.io/badge/Kids-Safe%20Content-blue.svg)](#-who-this-is-for)
...
<table>
  <tr>
    <td align="center"><img src="screenshots/presentation.png" alt="Cyber Safety Presentation" width="100%"/><br><sub><b>📊 Presentation</b> — ready for classroom or workshop use</sub></td>
    <td align="center"><img src="screenshots/checklist.png" alt="Interactive Checklist" width="100%"/><br><sub><b>✅ Interactive Checklist</b> — track safety habits in real time</sub></td>
...
1. Download the HTML files from the [`modules/`](modules/) or [`checklists/`](checklists/) folder
...
```
cyber-awareness-for-all/
├── presentations/          # PowerPoint deck for awareness sessions
├── modules/                # Interactive HTML learning modules
├── checklists/             # Printable & interactive HTML checklists
├── screenshots/            # README preview images
├── translations/           # Regional language versions (coming soon)
├── .github/
...
Contributions are warmly welcome from security professionals, educators, translators, and designers. Please read [CONTRIBUTING.md](CONTRIBUTING.md) before getting started.
